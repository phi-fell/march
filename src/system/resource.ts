...
export type ResourceClass<S extends t.Any, T extends Resource<S>> = new (id: string, path: string) => T;
...
export abstract class ResourceManager<S extends t.Any, T extends Resource<S>> {
    ...
    public async get(id: string): Promise<T | undefined> {
        if (this.res[id] === undefined) {
            try {
                this.res[id] = new this.resource_class(id, this.dir + '/' + id + this.extension);
...
export abstract class Resource<T extends t.Any> {
    ...
    public constructor(protected id: string, protected path: string) {
